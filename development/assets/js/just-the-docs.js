...
function initSearch() {
  ...
  request.open('GET', '/hf-mcp9700-driver/development/assets/js/search-data.json', true);
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', '/hf-mcp9700-driver/development/assets/css/just-the-docs-' + theme + '.css');
}
